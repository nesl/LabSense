...
sendToLabSense("MotionSensor", name, "128.97.93.190", 8000, 0, time, api_key)
sendToLabSense("MotionSensor", name, "128.97.93.190", 8000, 1, time + 1, api_key)
...
function fallingEdge()
    ...
    sendToLabSense("MotionSensor", name, "128.97.93.190", 8000, 1, time, api_key)
    sendToLabSense("MotionSensor", name, "128.97.93.190", 8000, 0, time + 1, api_key)
end
